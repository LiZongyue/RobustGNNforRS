...
class NGCF(nn.Module):
    ...
    def _train_with_val(self, adj, users, posItems, negItems, dataset, dataset_py):
        ...
        if self.is_gcmc:
            checkpoint_file_name = '{}/models/{}/GCMC_baseline_{}.ckpt'.format(local_path, dataset, use_dcl)
            log_file_name = '{}/log/{}/GCMC_baseline_{}.log'.format(local_path, dataset, use_dcl)
        else:
            checkpoint_file_name = '{}/models/{}/NGCF_baseline_{}.ckpt'.format(local_path, dataset, use_dcl)
